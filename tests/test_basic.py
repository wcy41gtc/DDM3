...
class TestMaterial:
    ...
    def test_material_creation(self):
        ...
        material = Material(
            shear_modulus=10e9, poisson_ratio=0.25, density=2650.0, name="Test Rock"
        )
...
class TestFiber:
    ...
    def test_linear_fiber_creation(self):
        ...
        fiber = Fiber.create_linear(
            fiber_id=1, start=(0, 0, 0), end=(100, 0, 0), n_channels=10
        )
    ...
    def test_fiber_validation(self):
        ...
        with pytest.raises(ValueError):
            Fiber.create_linear(
                fiber_id=1, start=(0, 0, 0), end=(100, 0, 0), n_channels=0
            )
...
class TestDDMCalculator:
    ...
    def test_fiber_response_calculation(self):
        ...
        # Create fiber
        fiber = Fiber.create_linear(
            fiber_id=1, start=(10, 5, -50), end=(10, 5, 50), n_channels=10
        )
